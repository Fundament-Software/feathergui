...
terra MockMsgReceiver:Behavior(w : &opaque, ui : &opaque, m : &Msg.Message) : Msg.Result
  if m.kind.val == [Msg.Receiver.virtualinfo.info["Draw"].index] then
    ...
    b:DrawArc(w, &r2, F.Vec{array(0f, 3f)}, 0xFF0000FF, 5f, 0xFF00FFFF, 0f, 10f, nil, 0f, nil)
    var r2b = F.Rect{array(250f, 150f, 300f, 200f)}
    b:DrawCircle(w, &r2b, 0xFFFFFFFF, 0f, 0xFFFFFFFF, 0f, 0f, 0f, nil, 0f, nil)
