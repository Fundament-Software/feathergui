...
namespace D2D {
  ...
  public:
    ...
    static FG_Err DrawTriangle(FG_Backend* self, void* window, FG_Rect* area, FG_Rect* corners, FG_Color fillColor, float border, FG_Color borderColor, float blur, FG_Asset* asset);
    static FG_Err DrawLines(FG_Backend* self, void* window, FG_Vec* points, uint32_t count, FG_Color color);
    static FG_Err DrawCurve(FG_Backend* self, void* window, FG_Vec* anchors, uint32_t count, FG_Color fillColor, float stroke, FG_Color strokeColor);
    ...
    static void* CreateWindowD2D(FG_Backend* self, FG_Element* element, uint64_t display, FG_Rect* area, const char* caption, uint64_t flags);
    static FG_Err SetWindowD2D(FG_Backend* self, void* window, FG_Element* element, uint64_t display, FG_Rect* area, const char* caption, uint64_t flags);
