/* FG_Direct2D - Direct2D Backend for Feather GUI
...
namespace D2D {
  ...
  public:
    ...
    FG_Asset* LoadAsset(const char* data, size_t count);
    FG_Result Behavior(void* data, FG_Msg& msg);
    ...
    static FG_Err DrawFont(FG_Backend* self, void* data, FG_Font* font, void* fontlayout, FG_Rect* area, FG_Color color, float lineHeight, float letterSpacing, float blur, FG_AntiAliasing aa);
    static FG_Err DrawAsset(FG_Backend* self, void* data, FG_Asset* asset, FG_Rect* area, FG_Rect* source, FG_Color color, float time);
    static FG_Err DrawRect(FG_Backend* self, void* data, FG_Rect* area, FG_Rect* corners, FG_Color fillColor, float border, FG_Color borderColor, float blur, FG_Asset* asset);
    static FG_Err DrawCircle(FG_Backend* self, void* data, FG_Rect* area, FG_Rect* arcs, FG_Color fillColor, float border, FG_Color borderColor, float blur, FG_Asset* asset);
    static FG_Err DrawTriangle(FG_Backend* self, void* data, FG_Rect* area, FG_Rect* corners, FG_Color fillColor, float border, FG_Color borderColor, float blur, FG_Asset* asset);
    static FG_Err DrawLines(FG_Backend* self, void* data, FG_Vec* points, uint32_t count, FG_Color color);
    static FG_Err DrawCurve(FG_Backend* self, void* data, FG_Vec* anchors, uint32_t count, FG_Color fillColor, float stroke, FG_Color strokeColor);
    static FG_Err PushLayer(FG_Backend* self, void* data, FG_Rect area, float* transform, float opacity);
    static FG_Err PopLayer(FG_Backend* self, void* data);
    static FG_Err PushClip(FG_Backend* self, void* data, FG_Rect area);
    static FG_Err PopClip(FG_Backend* self, void* data);
    ...
    static FG_Asset* CreateAsset(FG_Backend* self, const char* data, uint32_t count, FG_Formats format);
    ...
    static FG_Err GetDisplay(FG_Backend* self, unsigned long long handle, FG_Display* out);
    static FG_Err GetDisplayWindow(FG_Backend* self, void* window, FG_Display* out);
    static void* CreateWindowD2D(FG_Backend* self, void* data, uint64_t display, FG_Rect* area, const char* caption, uint64_t flags);
    static FG_Err SetWindowD2D(FG_Backend* self, void* window, void* data, uint64_t display, FG_Rect* area, const char* caption, uint64_t flags);
    ...
    static constexpr wchar_t TopWindowClass[] = L"WindowD2D";
    static constexpr wchar_t BaseWindowClass[] = L"BaseWindowD2D";
