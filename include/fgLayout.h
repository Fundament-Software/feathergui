...
FG_EXTERN FG_UINT FG_FASTCALL fgLayout_AddLayout(fgLayout* self, const char* name, const fgElement* element, fgFlag flags);
...
FG_EXTERN void FG_FASTCALL fgClassLayout_Init(fgClassLayout* self, const char* name, const fgElement* element, fgFlag flags);
FG_EXTERN void FG_FASTCALL fgClassLayout_Destroy(fgClassLayout* self);
FG_EXTERN FG_UINT FG_FASTCALL fgClassLayout_AddChild(fgClassLayout* self, const char* name, const fgElement* element, fgFlag flags);
...
FG_EXTERN fgChild* fgLayoutLoadMapping(const char* name, fgFlag flags, fgChild* parent, fgChild* prev, const fgElement* element);
