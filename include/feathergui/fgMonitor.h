...
FG_EXTERN void fgMonitor_Init(fgMonitor* BSS_RESTRICT self, fgFlag flags, struct _FG_ROOT* BSS_RESTRICT parent, fgMonitor* BSS_RESTRICT prev, const AbsRect* coverage, const AbsVec* dpi);
