...
Layout::Layout() : SkinBase(reinterpret_cast<fgSkinBase*>(new fgLayout()), true) { fgLayout_Init(reinterpret_cast<fgLayout*>(_p), 0, 0); }
Layout::Layout(System::String^ name) : SkinBase(reinterpret_cast<fgSkinBase*>(new fgLayout()), true) { TOCHAR(name); fgLayout_Init(reinterpret_cast<fgLayout*>(_p), (const char*)pstr, 0); }
Layout::Layout(System::String^ name, System::String^ path) : SkinBase(reinterpret_cast<fgSkinBase*>(new fgLayout()), true) { TOCHAR(name); TOCHARSTR(path, cpath); fgLayout_Init(reinterpret_cast<fgLayout*>(_p), (const char*)pstr, (const char*)cpath); }
